...
class StateList
{
	...
	public static function render()
	{
		return [
			...
			'MT' => __('Montana', 'polaris-forms'),
			'NE' => __('Nebraska', 'polaris-forms'),
			'NV' => __('Nevada', 'polaris-forms'),
			'NH' => __('New Hampshire', 'polaris-forms'),
			'NJ' => __('New Jersey', 'polaris-forms'),
			'NM' => __('New Mexico', 'polaris-forms'),
			'NY' => __('New York', 'polaris-forms'),
			'NC' => __('North Carolina', 'polaris-forms'),
			'ND' => __('North Dakota', 'polaris-forms'),
			'OH' => __('Ohio', 'polaris-forms'),
